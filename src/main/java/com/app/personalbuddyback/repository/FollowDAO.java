...
//    나를 구독한 유저의 리스트
    public List<ProfileCardDTO> findAllFollowers(Map<String, Object> map) {
        return followMapper.selectFollowerList(map);
    }
//    내가 구독한 유저의 리스트
    public List<ProfileCardDTO> findAllFollows(Map<String, Object> map) {
        return followMapper.selectFollowList(map);
    }
//    내가 즐겨찾기 한 유저의 리스트
